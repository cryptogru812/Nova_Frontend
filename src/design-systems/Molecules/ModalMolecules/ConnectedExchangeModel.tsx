...
export const ConnectedExchangeModel: React.FC<ConnectedModelProps> = ({ showModal, header, data, setShow }) => {
  ...
  return (
    <Model heading="Connect Exchange Edit" setShow={() => setShow(!showModal)} showModal={showModal}>
      <div>
